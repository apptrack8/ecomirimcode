...
const Footer = () => {
  ...
  const quickLinks = [
    ...
    { to: '/se-envolver', label: t('footer.getInvolved') },
    { to: '/nossa-missao', label: t('footer.mission') },
    { to: '/time', label: t('footer.team') }
  ]
  ...
  const socialLinks = [
    ...
    },
    {
      ...
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          <path d="M12.017 0C5.396 0 .029 5.367.029 11.987c0 6.62 5.367 11.987 11.988 11.987 6.62 0 11.987-5.367 11.987-11.987C24.014 5.367 18.637.001 12.017.001zM8.449 16.988c-1.297 0-2.448-.49-3.323-1.297C4.198 14.895 3.708 13.744 3.708 12.447s.49-2.448 1.297-3.323c.875-.807 2.026-1.297 3.323-1.297s2.448.49 3.323 1.297c.807.875 1.297 2.026 1.297 3.323s-.49 2.448-1.297 3.323c-.875.807-2.026 1.297-3.323 1.297zm7.83-9.781h-1.688c-.807 0-1.297-.49-1.297-1.297V4.121c0-.807.49-1.297 1.297-1.297h1.688c.807 0 1.297.49 1.297 1.297v1.789c0 .807-.49 1.297-1.297 1.297z"/>
        </svg>
      )
    },
    {
          ...
          <div className="text-center flex flex-col justify-center h-full">
            ...
            <div className="space-y-2 text-sm text-gray-300">
              <div className="flex items-start space-x-3 justify-center">
                ...
                <span>(11) 94231-5757</span>
              </div>
              <div className="flex items-start space-x-3 justify-center">
                <svg className="w-5 h-5 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span>equipe@ecomirim.eco.br</span>
              </div>
              <div className="flex items-start space-x-3 justify-center">
                <svg className="w-5 h-5 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
